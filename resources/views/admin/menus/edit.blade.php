            ...
            <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                <form method="POST" action="{{ route('admin.menus.update',$menu->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div>
                            <img src="{{Storage::url($menu->image)}}" class="w-20 h-17 rounded">
                        </div>
                        <div class="mt-1">
                    ...
                    <div class="sm:col-span-6 pt-5">
                        ...
                        <div class="mt-1">
                            <textarea type="text" id="ingredients"  name="ingredients" class="block w-full  appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                                {{$menu->ingredients}}
                            </textarea>
                        </div>
                        @error('ingredients')
                    ...
                    <div class="sm:col-span-6 pt-5">
                        ...
                        <div class="mt-1">
                            <textarea type="text" id="description"  name="description" class="block w-full  appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                                {{$menu->description}}
                            </textarea>
                        </div>
                        @error('description')
                    ...
                    <div class="sm:col-span-6 pt-5">
                        ...
                        <div class="mt-1">
                            <select id="chef_id" name="chef_id" class="form-multiselect block w-full mt-1"
                                >
