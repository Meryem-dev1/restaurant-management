                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-4 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <a href="{{route('admin.menus.index')}}" class="font-weight-bold btn btn-link">
                                Dashboard
                            </a>
                        </div>
                        <div class="col-sm-4 d-flex flex-column align-items-center justify-content-center">
                            <i class="fa fa-shopping-bag fa-5x text-primary"></i>
                            <a href="{{route('payments.index')}}" class="font-weight-bold btn btn-link">
                                Orders
                            </a>
                        </div>
                        <div class="col-sm-4 d-flex flex-column align-items-center justify-content-center">
                            <i class="fa fa-clipboard-list fa-5x text-success"></i>
                            <a href="{{route('reports.index')}}" class="font-weight-bold btn btn-link">
                                Reports
                            </a>
                        </div>
                    </div>
