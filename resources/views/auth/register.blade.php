<x-guest-layout>
    <h3 style="font-size: 24px; color: black; text-align: center; margin-bottom: 20px;">Sign Up </h3>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="tel_number" class="block mt-1 w-full" type="text" name="tel_number" :value="old('tel_number')" required autofocus autocomplete="tel_number" />
