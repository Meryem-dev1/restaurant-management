...
<html lang="en">
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb">
                    ...
                    @foreach ($menus as $menu)
                        <div class="col-md-6">
                                ...
                                <div class="menus d-sm-flex ftco-animate align-items-stretch">
                                    ...
                                    {{-- <img src="{{Storage::url($menu->image)}}" style="width:200;height:200px;" class=" rounded"> --}}
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                  <div class="img" style="background-image: url('{{Storage::url($chef->image)}}');"></div>
  ...
  @if(session('reservationAlert'))
  <script>
    alert("votre reservation et lire");
    setTimeout(() => {
        $('alert').hide();
